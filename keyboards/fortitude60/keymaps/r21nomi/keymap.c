 ...
 * |------+------+------+------+----------+--------|                   |--------+------+------+------+------+----------------|
 * | Caps |   A  |   S  |   D  |     F    |    G   |                   |   H    |   J  |   K  |   L  |   ;  |LT(_NAV, KC_ENT)|
 * |------+------+------+------+----------+--------+-------------------+--------+------+------+------+------+----------------|
...
[_SYMB] = LAYOUT( \
  ...
  KC_LSFT, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILD, _______, _______, KC_0,    KC_1,    KC_2,    KC_3,    KC_ASTR, KC_RSFT,
                    _______, _______, KC_LCTL, KC_DEL,  KC_ESC,  KC_SPC,  KC_BSPC, KC_0,    _______, _______
),
...
[_NAV] = LAYOUT( \
  _______, _______,    _______,             _______, _______,             _______,                     _______, _______, _______, _______, _______, _______,
  _______, _______,    LGUI(LSFT(KC_LCBR)), KC_UP,   LGUI(LSFT(KC_RCBR)), _______,                     _______, _______, _______, _______, _______, _______,
  _______, RCTL(KC_A), KC_LEFT,             KC_DOWN, KC_RIGHT,            RCTL(KC_E),                  _______, _______, _______, _______, _______, _______,
